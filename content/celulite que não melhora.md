...
- **Top 3 Causas de Pseudocelulite (54% dos casos):**
  ...
  - 3. Edema / Linfedema crônico.
- **Ferramenta Auxiliar (Termografia / Imagem Térmica):**
  - Celulite verdadeira gera calor intenso (Diferença média de **3.7°C** em relação ao membro sadio).
  - Condições não-inflamatórias (Pseudocelulite) apresentam diferença térmica mínima (média de **0.2°C**). Útil em pacientes com pele retinta onde o eritema é difícil de visualizar.

## **Passo 4: Avaliar Falha Antimicrobiana e Resistência (Erro na escolha empírica).**
- O tratamento empírico de primeira linha para celulite não purulenta deve focar nos Estreptococos beta-hemolíticos (70-75% dos casos).
- **A armadilha da Clindamicina:**
  - Se o paciente não melhorou e estava em uso de Clindamicina empírica (geralmente prescrita por alergia à penicilina), presuma resistência. 
